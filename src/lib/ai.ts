...
import { AIResponseSchema, type AIResponse, type Difficulty } from './schemas/ai-question.schema';
...
export async function generateQuestionWithAI(
  ...
  const systemPrompt = `You are an educational content expert creating high-quality quiz questions.
...
- All generated text MUST be in Italian.`;
